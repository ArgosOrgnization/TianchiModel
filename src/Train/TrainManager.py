...
class TrainManager:
    ...
    def __init__(
        ...
        default_test_data_save_path: str = "data/result/test_data.csv",
        default_check_point_save_path: str = "data/result/check_points/check_point.pth.tar",
        ...
        self.default_test_data_save_path: str = default_test_data_save_path
        self.default_check_point_save_path: str = default_check_point_save_path
    ...
    def test(self, file_save_path: str = None) -> pd.DataFrame:
        ...
        for _, (images, image_file_names) in enumerate(self.test_dataset):
            ...
            images_tensor: torch.Tensor = torch.tensor(images, requires_grad=False).cuda()
            with torch.no_grad():
                predict_labels: torch.Tensor = self.model(images_tensor)
        ...
        if file_save_path is not None:
            ...
            assureFilePathExists(self.default_test_data_save_path)
            df.to_csv(self.default_test_data_save_path, index=True)
            pass
        pass
